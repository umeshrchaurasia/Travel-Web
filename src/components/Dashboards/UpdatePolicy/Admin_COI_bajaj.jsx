...
const Admin_COI_bajaj = () => {
    ...
    const fetchEmployeeProposalsWithDates = async (fromDate, toDate) => {
        ...
        try {
            ...
            const response = await getProposalDetailsByAdmin_bajaj(fromDate, toDate);
    ...
    const fetchEmployeeProposals = async () => {
        ...
        try {
            ...
            const response = await getProposalDetailsByAdmin_bajaj(startDate, endDate);
                                            ...
                                            return (
                                                <tr key={index} className={index % 2 === 0 ? "coi-table-row-even" : "coi-table-row-odd"}>
                                                    ...
                                                    <td className="coi-table-cell">
                                                        {proposal.BajajUrl ? (
                                                            <a
                                                                href={`${PDF_BASE_URL}${proposal.BajajUrl}`}
                                                                target="_blank"
...
export default Admin_COI_bajaj
