...
const ReplenishWallet_bajaj = () => {
  ...
  const fetchBatchPayments = useCallback(async () => {
    try {
      ...
      const response = await getBatchPaymentsByStatus_bajaj('InProcess');
  ...
  const fetchWalletApplications = useCallback(async () => {
    try {
      ...
      const response = await getWalletApplications_bajaj();
  ...
  const handleSubmitPayment = async (payment) => {
    ...
    try {
      ...
      const response = await updateBatchPayment_bajaj(paymentData);
  ...
  const handleApproveApplication = async (application) => {
    ...
    try {
      ...
      const response = await processWalletApplication_bajaj({
...
export default ReplenishWallet_bajaj;